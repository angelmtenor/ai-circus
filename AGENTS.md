...
This document defines the foundational mandates and operational workflows for GenAI assistants (including the Gemini CLI and project-internal agents). Adherence to these rules is STRICTLY MANDATORY to ensure repository integrity, security, and quality.
